...
@section('header', 'Cập nhật Học phần')
            ...
            <form action="{{ route('admin.courses.update', $course) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('number_of_credits') is-invalid @enderror"
                            id="number_of_credits" name="number_of_credits"
                            value="{{ old('number_of_credits', $course->number_of_credits) }}" required min="1">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="practice_hours" name="practice_hours"
                            value="{{ old('practice_hours', $course->practice_hours) }}">
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="status" name="status">
                        <option value="active" {{ $course->status == 'active' ? 'selected' : '' }}>Hoạt động</option>
                        <option value="inactive" {{ $course->status == 'inactive' ? 'selected' : '' }}>Ngừng hoạt động
                        </option>
                    </select>
                </div>
