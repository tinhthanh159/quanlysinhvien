...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('lecturer.attendance.store_session', $courseClass) }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ route('lecturer.attendance.index', $courseClass) }}" class="btn btn-secondary">Hủy</a>
            </form>
        </div>
    </div>
@endsection
