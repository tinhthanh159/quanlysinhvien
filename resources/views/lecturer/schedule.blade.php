                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <tr>
                                ...
                                @foreach (['2', '3', '4', '5', '6', '7', 'CN'] as $day)
                                    @php
                                        // Check if a class exists for this day and period
                                        ...
                                        // Check if this is the starting period of the class
                                        $isStart = $class && $class->period_from == $i;

                                        // Check if this is a continuation of a class started earlier
                                        $isContinuation = $class && $class->period_from < $i;
                                    @endphp

                                    @if ($isStart)
                                        <td rowspan="{{ $class->period_to - $class->period_from + 1 }}"
                                            class="bg-info bg-opacity-10 border-info align-middle">
                                            <div
                                                class="p-2 rounded border border-info bg-white shadow-sm h-100 d-flex flex-column justify-content-center">
